...
export class LayerManager {
    ...
    private constructor() {
        ...
        // CAPAS SUPERPUESTAS
        // ------ Global
        // TODO temporal: solo CCAA+provincias mientras se resuelve el problema de rendimiento con municipios
        ...
        this.addTopLayer({name:"Límites provinciales (Eurostat NUTS)", url:"./NUTS_RG_10M_2021_3857.json", type:AL_TYPE_TOPO_JSON, global:false, credit:'© <a href="https://ec.europa.eu/eurostat" target="_blank">Eurostat</a> — EuroGeographics', featureFilter: (f: any, _resolution: number) => { const p = f.getProperties(); return p.CNTR_CODE === 'ES' && p.LEVL_CODE === 2; }})
        ...
        // TODO: WMS de wms.mapama.gob.es desactivados — NullReferenceException en ConstruirServiceArcGISBaseUrl() del servidor (backend ArcGIS caído). Reactivar cuando el Ministerio lo resuelva.
